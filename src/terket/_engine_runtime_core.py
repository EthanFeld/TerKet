...
# Exact twin-class DP. Runtime is O(n + t*2^t), where t is neighborhood
# diversity. This catches dense low-rank q2 graphs missed by treewidth.
_Q3_FREE_NEIGHBORHOOD_MAX_CLASSES = 20
_Q3_FREE_NEIGHBORHOOD_MAX_STATES = 1 << 20
_Q3_FREE_NEIGHBORHOOD_MAX_WORK_PER_VAR = 256
_Q3_FREE_NEIGHBORHOOD_TREEWIDTH_MAX_WIDTH = 20
_Q3_FREE_NEIGHBORHOOD_TREEWIDTH_MAX_WORK = 30_000_000
_Q3_FREE_NEIGHBORHOOD_TREEWIDTH_MAX_CLASSES = 512
...
# Region contraction is an optional exact fast path. If selected regions leave a
# large q2 core, ordering that core costs more than it saves on hard instances.
_Q3_FREE_REGION_CLUSTER_MAX_CORE_ORDER_VARS = 512
_Q3_FREE_REGION_CLUSTER_MAX_CORE_ORDER_FACTORS = 2048
_Q3_FREE_ORDER_GUIDED_CUTSET_MAX_PEAKS = 12
_Q3_FREE_ORDER_HINT_MAX_WIDTH = 12
_Q3_FREE_CHEAP_ORDER_HINT_MIN_VARS = 128
_Q3_FREE_TREEWIDTH_HEURISTIC_MAX_ORDER_VARS = 2048
_Q3_FREE_SERIES_CORE_RECURSE_MIN_VARS = 128
_Q3_FREE_SERIES_CORE_RECURSE_MIN_SHRINK = 64
_Q3_FREE_FEEDBACK_FOREST_MAX_BRANCH_VARS = 24
